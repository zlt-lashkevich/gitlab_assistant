...
5. **Логирование основных элементов работы бота**
   * Отслеживание работы программы и пути обработки запросов
...
- gitlab_username/github_username (ID из полученных токенов пользователя)
...
**NotificationSettings** - Персонализированные настройки фильтрации уведомлений
- Упоминания
- Назначение ревьюером
- Завершение пайплайнов (только для своих MR)
- Мердж своих MR
